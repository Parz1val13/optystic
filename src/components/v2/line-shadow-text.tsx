...
/* MagicUI line-shadow-text, vendored from magicui.design/r/line-shadow-text.
 * One adaptation: `after:animate-line-shadow` became the `v2-line-shadow`
 * class (rule lives in v2.css) because this project defines no custom
...
export function LineShadowText({
  ...
  return (
    <MotionComponent
      ...
      className={cn(
        "v2-line-shadow relative z-0 inline-flex",
